# Домашнее задание к занятию «Использование Terraform в команде» -- Мельник С В
...
- Отсутствует ограничение версии для провайдера "яндекс" в required_providers;
- переменные "vms_ssh_root_key", "vm_web_name", "vm_db_name" объявлены, но не используется;
